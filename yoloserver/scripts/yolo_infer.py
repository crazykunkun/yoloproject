...
from infer_frame import process_frame # 处理单帧图像的
from logging_utils import setup_logger, log_parameters
from config_utils import load_config,merge_configs
from system_utils import log_device_info

from beautify import (BASE_FONT_PATH, TEXT_COLOR, calculate_beautify_params)
from paths import YOLOSERVER_ROOT,LOGS_DIR,CHECKPOINTS_DIR
...
def parse_args():
    ...
    parser.add_argument("--weights", type=str,
            default=r"D:\学习\实习\yoloserver\models\checkpoints\seg_best.pt", help="模型权重信息路径")
    parser.add_argument("--source", type=str,
            default=r"D:\学习\实习\yoloserver\data\test\images", help="推理数据源")
